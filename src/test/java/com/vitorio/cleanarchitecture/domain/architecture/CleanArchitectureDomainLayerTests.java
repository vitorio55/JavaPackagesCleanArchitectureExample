package com.vitorio.cleanarchitecture.domain.architecture;
...
class CleanArchitectureDomainLayerTests extends ArchitectureTests {

    @ArchTest
    static final ArchRule should_respect_layer_dependencies_regarding_domain_layer = layeredArchitecture()
        ...
        .whereLayer(domainLayer).mayOnlyBeAccessedByLayers(useCaseLayer);
